...
type PreviewTripRequest struct {
	...
	StartingLocation *Coordinate            `protobuf:"bytes,2,opt,name=startingLocation,proto3" json:"startingLocation,omitempty"`
...
func (x *PreviewTripRequest) GetStartingLocation() *Coordinate {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	...
	"\x10startingLocation\x18\x02 \x01(\v2\x10.trip.CoordinateR\x10startingLocation\x122\n" +
...
var file_trip_proto_depIdxs = []int32{
	0,  // 0: trip.PreviewTripRequest.startingLocation:type_name -> trip.Coordinate
	0,  // 1: trip.PreviewTripRequest.endLocation:type_name -> trip.Coordinate
	...
	0,  // 5: trip.Geometry.coordinates:type_name -> trip.Coordinate
	8,  // 6: trip.CreateTripResponse.trip:type_name -> trip.Trip
	4,  // 7: trip.Trip.selectedRideFare:type_name -> trip.RideFare
	...
	2,  // 12: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
